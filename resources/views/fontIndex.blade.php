            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="product.html" class="nav-item nav-link">Công Cụ</a>
                        <a href="product.html" class="nav-item nav-link">Giải Pháp</a>
                        <a href="product.html" class="nav-item nav-link">Tin Tức</a>
                    </div>
                </div>
